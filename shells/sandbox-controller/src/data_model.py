        ...
        for (parent, resource) in dict[rank]:
            if parent == resource_relative_addr:
                ...
                manipulated_resource.add_sub_resource(
                    self.__slice_parent_from_relative_path(parent, resource.relative_address),
                    sub_resource,
                )
...
class SandboxController(object):
    def __init__(self, name):
        """"""
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = "Sandbox Controller"
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype SandboxController
        """
        result = SandboxController(name=context.resource.name)
    ...
    def blueprint_name(self):
        ...
        """
        return (
            self.attributes["Sandbox Controller.Blueprint Name"]
            if "Sandbox Controller.Blueprint Name" in self.attributes
            else None
        )

    @blueprint_name.setter
    def blueprint_name(self, value):
        """
        name of blueprint
        :type value: str
        """
        self.attributes["Sandbox Controller.Blueprint Name"] = value

    @property
    def sandbox_owner(self):
        """
        :rtype: str
        """
        return (
            self.attributes["Sandbox Controller.Sandbox Owner"]
            if "Sandbox Controller.Sandbox Owner" in self.attributes
            else None
        )

    @sandbox_owner.setter
    def sandbox_owner(self, value):
        """
        owner of sandbox
        :type value: str
        """
        self.attributes["Sandbox Controller.Sandbox Owner"] = value
    ...
    def permitted_users(self):
        ...
        """
        return (
            self.attributes["Sandbox Controller.Permitted Users"]
            if "Sandbox Controller.Permitted Users" in self.attributes
            else None
        )

    @permitted_users.setter
    def permitted_users(self, value):
        """
        comma separated list of permitted users. Users MUST have appropriate domain permissions.
        :type value: str
        """
        self.attributes["Sandbox Controller.Permitted Users"] = value
    ...
    def sandbox_id(self, value):
        ...
        :type value: str
        """
        self.attributes["Sandbox Controller.Sandbox Id"] = value
    ...
    def global_inputs(self):
        ...
        """
        return (
            self.attributes["Sandbox Controller.Global Inputs"]
            if "Sandbox Controller.Global Inputs" in self.attributes
            else None
        )

    @global_inputs.setter
    def global_inputs(self, value):
        """
        pass in semicolon separated string of key value pairs (input1,asdf;input2,val2;input 3,val3)
        :type value: str
        """
        self.attributes["Sandbox Controller.Global Inputs"] = value
    ...
    def email_notifications(self):
        ...
        """
        return (
            self.attributes["Sandbox Controller.Email Notifications"]
            if "Sandbox Controller.Email Notifications" in self.attributes
            else None
        )

    @email_notifications.setter
    def email_notifications(self, value="True"):
        """
        email notifications
        :type value: str
        """
        self.attributes["Sandbox Controller.Email Notifications"] = value
